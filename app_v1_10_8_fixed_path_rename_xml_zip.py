...
# ---------------------------------------------------------------------------------------------------------
# v1.10.8 - XML renaming ZIP output added; fixed Path import; strength only from XML/product name
...
with tab1:
    ...
    if uploaded_files:
        ...
        for idx, uploaded_file in enumerate(uploaded_files, start=1):
            ...
            molecule_names_for_filename = [product_norm_to_pretty.get(pnorm, pnorm).title() for pnorm in sorted(list(case_products_norm))]
            suggested_xml_filename = build_suggested_xml_filename(sender_id, validity_value, case_has_serious_event, molecule_names_for_filename, fallback_stem=original_file_stem)
